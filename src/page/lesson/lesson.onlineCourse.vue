            ...
            <section>
                <div class="lc_oc_screen">
                    ...
                    <div class="oc_screen_search">
                        ...
                        placeholder="onionName" model="keywords.cname"/>
                ...
                <ul class="lc_oc_list">
                    <li class="oc_list_item" v-for="(course, index) in courseList" v-bind:key="index">
                        ...
                        <div class="oc_list_info"><a href="" click="getClickData(course.id)" class="disBlock">
                            ...
                            <div class="size12 colorb1b6ba marT9"><span class="marR15">Star：{{course.conut?course.conut:'0'}}</span>|<span class="marL15">Fork：{{course.studentSum}}</span></div>
                        </a></div>
                    </li>
                </ul>
            </section>
...
export default {
    data () {
        return {
            orderList: [
                {type:'lastupdatedate',name:'Latest'},
                {type:'conut',name:'Star'},
                {type:'pjpoint',name:'Fork'}
            ],
            courseList: []
        }
    },
